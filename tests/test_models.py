...
class TestProductModel(unittest.TestCase):
    ...
    def test_add_a_product(self):
        ...
        # Assert that the properties of the found_product match the original product object.
    ...
    def test_delete_a_product(self):
        ...
        # Delete the product and confirm deleted
        product.delete()
    ...
    def test_list_all_products(self):
        ...
        products = Product.all()
        # Check list is empty at start of test
        self.assertEqual(products, [])
        # Use productfactory to create 5 products
        for _ in range(5):
            product = ProductFactory()
            product.create()
        # Check all five products exist
        products = Product.all()
    ...
    def test_find_by_price_str(self):
        """It should Find Products by Price when given price as string"""
        product = ProductFactory()
        product.create()
